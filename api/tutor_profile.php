...
if($RequestMethod == "POST"){
    try {
        ...
        $UserArray["total_bookings"]          = getTutorsTotalBookings($conn, $user_id);
        $UserArray["total_pending_bookings"]  = getTutorsPendingBookings($conn, $user_id);
        $UserArray["total_completed_bookings"] = getTutorsCompletedBookings($conn, $user_id);
        $UserArray["total_running_bookings"] = getTutorsRunningBookings($conn, $user_id);
        $UserArray["total_tutoring_course"] = getTutoringCourses($conn, $user_id);
